...
public class Application {
	public static void main(String[] args) {
		...
		IAccountService stopWatchProxy;
		ClassLoader classLoader=accountService.getClass().getClassLoader();
		stopWatchProxy=(IAccountService) Proxy.newProxyInstance(classLoader,
				new Class[]{IAccountService.class},new StopWatchProxy(accountService));
